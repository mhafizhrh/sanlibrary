        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <a href="<?php echo base_url(); ?>katalog_buku/tambah_buku" class="btn btn-primary"><i class="fa fa-user-plus"></i> Tambah Buku Baru</a>
                </div>
                <div class="form-group row">
                    <form class="col-md-6" method="post" action="<?php echo base_url('katalog_buku/data_buku/search'); ?>">
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                                <?php foreach ($data_buku as $data) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?=base_url()?>katalog_buku/edit_buku/<?=$data->id_buku?>" class="btn btn-warning" onlick="warning()"><i class="fa fa-edit"></i></a>
                                        </td>
                                        <td>
                                            <a onclick="warning('<?php echo $data->id_buku?>')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                        <td>
